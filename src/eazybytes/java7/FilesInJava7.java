...
public class FilesInJava7 {
    private static final String HOME_DIR = "D:\\projects\\java8\\src\\eazybytes";
    ...
    private static void workingWithFiles() throws IOException {
        ...
        System.out.println("Content of this file is: " + content);
        ...
        Path newPath = Paths.get(HOME_DIR, "new_java8");


            Files.createDirectory(newPath);
            Path filePath = Paths.get(HOME_DIR, "new_java8", "Hello.txt");
            Files.createFile(filePath);

            Path newFilePath = Paths.get(HOME_DIR, "new_java8", "Test.txt");
