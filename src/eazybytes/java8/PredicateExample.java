...
//        Predicate OR Chaining
        System.out.println("Is the number 61 is either even or greater than 50 ? :" + isGreaterThan50.or(isEven).test(61));
...
//        Usage of Predicate inside Collections & Streams
        ...
        System.out.println("Is the input string equal: " + checkEquality.test("Eazy Bytes"));
