...
//        We should use of() when we are sure that value will present, otherwise go for ofNullable()
...
//        country.ifPresentOrElse(value1 -> System.out.println("Value is present, its: "+ value1), () -> {
